...
function creerModel($nomTable,$donnees){
	...
	$f = fopen($folder.'/modeles/'.ucfirst($nomTable).'Modele.php', 'w+') ;
	fclose($f);
	file_put_contents($folder.'/modeles/'.ucfirst($nomTable).'Modele.php', $fichier) ;
...
function functionCreer($nomTable,$donnees){
	...
	$l1 = $t1."public function creer".ucfirst($nomTable)."($".$nomTable.", \$bd) \n".$t1."{ \n" ;
...
function functionMettreAjour($nomTable,$donnees){
	...
	$l1 = $t1."public function mettreAjour".ucfirst($nomTable)."($".$nomTable.", \$bd) \n".$t1."{ \n" ;
...
function functionSupprimer($nomTable,$donnees){
	...
	$l1 = $t1."public function supprimer".ucfirst($nomTable)."($".$nomTable.", \$bd) \n".$t1."{ \n" ;
...
function functionTrouver($nomTable,$donnees){
	...
	$l1 = $t1."public function trouver".ucfirst($nomTable)."($".$nomTable.", \$bd) \n".$t1."{ \n" ;
...
function functionTrouverTous($nomTable,$donnees){
	...
	$l1 = $t1."public function trouverTous".ucfirst($nomTable)."(\$bd) \n".$t1."{ \n" ;
